@extends('layouts.app')
@section('master-title', 'Sahbandar/')
    ...
    <main>
        <section class="content">
            ...
            <div class="container-fluid">
                ...
                <form action="{{ route('pemerintahan-pkk.update', $data->id) }}" method="post"
                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="d-flex flex-column">
                                            ...
                                            <img class="img-fluid rounded-circle"
                                                src="{{ asset('storage/sahbandar/' . $data->profile) }}" alt="Foto Profile"
                            ...
                            <div class="d-flex flex-row-reverse">
                                <a href="{{ route('pemerintahan-sahbandar.index') }}" class="btn btn-danger">Kembali</a>
                            </div>
