...
@section('contents')
    ...
    <main>
        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('pemerintahan-rt.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-row-reverse">
                            ...
                            <a href="{{ route('pemerintahan-rt.index') }}" class="btn btn-danger">Batal</a>
                        </div>
