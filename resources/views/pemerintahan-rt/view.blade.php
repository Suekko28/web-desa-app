    ...
    <main>
        <section class="content">
            ...
            <div class="container-fluid">
                ...
                <form action="{{ route('pemerintahan-posyandu.update', $data->id) }}" method="post"
                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="d-flex flex-column">
                                            ...
                                            <img class="img-fluid rounded-circle"
                                                src="{{ asset('storage/rt/' . $data->profile) }}" alt="Foto Profile"
                            ...
                            <div class="d-flex flex-row-reverse">
                                <a href="{{ route('pemerintahan-rt.index') }}" class="btn btn-danger">Kembali</a>
                            </div>
