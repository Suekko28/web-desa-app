...
@section('contents')
    ...
    <main>
        <form action="{{ route('sirkulasi-melahirkan.index') }}" method="GET" enctype="multipart/form-data">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="date" class="form-control" id="tgl_lahir_start" name="tgl_lahir_start"
                                    placeholder="">
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="date" class="form-control" id="tgl_lahir_end" name="tgl_lahir_end"
                                    placeholder="">
                            </div>
