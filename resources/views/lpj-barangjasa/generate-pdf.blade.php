...
<body>
    ...
    <main class="flex-grow-1">
        ...
        <p class="alamat text-center" style="margin-top: -10px">Alamat: Jl. Industri No.65 Desa Tarikolot Citereup Bogor
            16810 Telp. (021)
            87943708></p>
        <p class="text-wrap" style="margin-top: 2em; text-indent: 20px;">Pada hari ini, {{ $tanggal_hari_ini }}, Kami yang
        ...
        <br>
        <br>
        <p style="text-indent: 20px;">Berdasarkan Surat Keputusan Kepala Desa Tarikolot Nomor {{ $data_belanja->no_berita_acara }} Tahun 2024 tanggal {{ $data_belanja->tgl_bast }}
            tentang Penetapan Tim Pemeriksa Pekerjaan/Penerima Barang/Jasa Desa Tarikolot Tahun 2024, Kami selaku Tim
            Pemeriksa Pekerjaan/Penerima Barang/Jasa telah melaksanakan Pemeriksaan Barang yang diserahkan oleh: {{ $data->first()->nama_toko }}</p>
        <br>
        <p style="text-indent: 20px;">Berdasarkan Surat Pesanan Nomor {{ $data_belanja->no_pesanan_brg }} tanggal {{ $date_pesanan }},
        ...
        <p style="text-indent: 20px;">Dalam hal ini bertindak untuk dan atas nama {{ $data->first()->nama_toko }} selaku
