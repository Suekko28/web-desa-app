...
class PemerintahanMUIDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $actionBtn .= '<div class="col">
        <a href="' . route('pemerintahan-mui.index') . '/{{ $id }}" name="view" class="btn btn-primary mt-2"><i class="fa-solid fa-eye"></i></a>';
    ...
    public function html(): HtmlBuilder
    {
        $btn = [
            ...
            Button::make('pdf')
                ...
                ->text('PDF')
                ->action('function() {
                window.location.href = "' . route('pemerintahan-mui.generate-pdf') . '";
            }'),
